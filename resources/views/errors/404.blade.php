                ...
                <div class="container container-setting">
                    <div class="row justify-content-center about_us_nav">
                        <nav class="navbar navbar-expand contact-us-nav navbar-light bg-light">
                            <a href="..\index-product.html" class="navbar-brand"> <img src="img\logo.png"
                                    alt="logo"></a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                                <ul class="navbar-nav ml-auto header-nav">
                                    <li class="nav-item dropdown dmenu d-none d-md-block">
                                        <a class="nav-link dropdown-toggle" href="#" id="navbardrop"
                                            data-toggle="dropdown">
                                            ENG
                                        </a>
                                        <div class="dropdown-menu sm-menu">
                                            <a class="dropdown-item" href="#"><img src="img\flags\russia.jpg"
                                                    alt="Russia">Russia</a>
                                            <a class="dropdown-item" href="#"><img src="img\flags\french.jpg"
                                                    alt="French">French</a>
                                            <a class="dropdown-item" href="#"><img src="img\flags\spain.jpg"
                                                    alt="spain">Spanish</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown dmenu d-none d-md-block">
                                        ...
                                        <div class="dropdown-menu sm-menu">
                                            <a class="dropdown-item" href="#"><img src="img\flags\usd.png"
                                                    alt="flag_usa">USD</a>
                                            <a class="dropdown-item" href="#"><img src="img\flags\eur.png"
                                                    alt="flag_eur">EUR</a>
                                            <a class="dropdown-item" href="#"><img src="img\flags\aud.png"
                                                    alt="flag_cad">CAD</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown dmenu d-none d-md-block">
                                    ...
                                    <li class="nav-item dropdown cart-item">
                                        ...
                                        <div class="dropdown-menu sm-menu mini-cart">
                                                ...
                                                <div class="inner-card">
                                                    <div class="media">
                                                        <div class="img-holder ml-1 mr-2">
                                                            <img src="img\m1.jpg" class="align-self-center"
                                                                alt="cartitem">
                                                        </div>
                                                        <div class="media-body mt-auto mb-auto">
                                                            <h5 class="name">Shoes</h5>
                                                            <p class="category">Adidas Shoes Lastest</p>
                                                            <p class="price"><span>$20</span>(x1) <a href="#">
                                                                    <i class="fa fa-trash dustbin"></i></a></p>
                                                        </div>
                                                    </div>
                                                    <div class="media">
                                                        <div class="img-holder ml-1 mr-2">
                                                            <img src="img\m2.jpg" class="align-self-center"
                                                                alt="cartitem">
                                                        </div>
                                                        <div class="media-body mt-auto mb-auto">
                                                            <h5 class="name">Shoes</h5>
                                            ...
                                            <div class="mini-cart-footer">
                                                ...
                                                <div class="actions">
                                                    <button type="button" class="btn view-bag rounded-pill">View
                                                        Bag</button>
                                                    <button type="button"
                                                        class="btn view-cart  btn-medium btn-gradient rounded-pill">Checkout</button>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
            ...
            <div class="side-menu-nav">
                ...
                <nav>
                    <ul class="side-bar">
                        ...
                        <li class="nav-item active main-item">
                            <a class="nav-link nav-appear" id="demo1">Blog <i
                                    class="fas fa-caret-right forward"></i></a>
                            <div class="submenu-overlay">
                                <ul class="d-flex justify-content-lg-center">
                                    <li class="nav-item d-flex align-items-center">
                                        <a class="sub-menu-nav-appear"><i
                                                class="fas fa-arrow-alt-circle-left go-back-btn"></i></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link sub-menu-nav-appear" href="blog.html">Standard Blog</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link sub-menu-nav-appear" href="single-blog.html">Single
                                            Blog</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item main-item">
                            <a class="nav-link nav-appear" id="demo2">Products <i
                                    class="fas fa-caret-right forward"></i></a>
                            <div class="submenu-overlay">
                                <ul class="d-flex justify-content-lg-center">
                                    <li class="nav-item d-flex align-items-center">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link sub-menu-nav-appear"
                                            href="product-listing-light.html">Product Listing One</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link sub-menu-nav-appear"
                                            href="product-listing-dark.html">Product Listing Two</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link sub-menu-nav-appear" href="product-detail.html">Product
                                            Detail Version</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link sub-menu-nav-appear" href="shop-cart.html">Shopping
                                            Cart</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item main-item">
                            <a class="nav-link nav-appear" id="demo3">Pages <i
                                    class="fas fa-caret-right forward"></i></a>
                            <div class="submenu-overlay">
                                <ul class="d-flex justify-content-lg-center">
                                    <li class="nav-item d-flex align-items-center">
                ...
                <div class="side-footer">
                    <ul class="social-icons-simple">
                        <li><a href="#." class="facebook_bg_hvr2 wow fadeInUp"><i class="fab fa-facebook-f"
                                    aria-hidden="true"></i></a></li>
                        <li><a href="#." class="twitter_bg_hvr2 wow fadeInDown"><i class="fab fa-twitter"
                                    aria-hidden="true"></i></a> </li>
                        <li><a href="#." class="linkdin_bg_hvr2 wow fadeInUp"><i class="fab fa-linkedin-in"
                                    aria-hidden="true"></i></a></li>
                        <li><a href="#." class="instagram_bg_hvr2 wow fadeInDown"><i class="fab fa-instagram"
                                    aria-hidden="true"></i></a></li>
                    </ul>
                    <p class="whitecolor text-center w-100 wow fadeInDown">&copy; 2019 MegaOne. Made With Love by <a
                            class="web-link" href="http://www.themesindustry.com/" target="_blank">Themesindustry</a>
                    </p>
                </div>
            </div>
            <!-- End Overlay Menu -->
