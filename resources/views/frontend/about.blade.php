    ...
    <div class="product-section contact-body">
        ...
        <div class="contact-us-content">
            <div class="slider-content">
                <div class="parallax-slide banner-slide" style='background:url("{{ asset('images/img/project-banner10.jpg') }}")'>
                </div>
                    ...
                    <div class="clients owl-carousel owl-theme no-gutters">
                        <div class="item client-container">
                            ...
                            <div class="client-img-holder rounded-circle center-block">
                                <img src="{{ asset('images/img\client1.jpg') }}" class="rounded-circle" alt="client1">
                            </div>
                        ...
                        <div class="item client-container">
                            ...
                            <div class="client-img-holder rounded-circle center-block">
                                <img src="{{ asset('images/img\client2.png') }}" class="rounded-circle" alt="client1">
                            </div>
                            <div class="client-detail col-12 text-center">
                                <h4 class="client-name">Ellizabeth Taylor</h4>
                                <p class="client-des">Amazon</p>
                        ...
                        <div class="item client-container">
                            ...
                            <div class="client-img-holder rounded-circle center-block">
                                <img src="{{ asset('images/img\client3.png') }}" class="rounded-circle" alt="client1">
                            </div>
                            <div class="client-detail col-12 text-center">
                                <h4 class="client-name">Ellizabeth Taylor</h4>
                                <p class="client-des">Amazon</p>
